    ...
    match behavior {
        ...
        Behavior::Unknown {
            ...
            if *param1 != 0 && *param2 != 0 {
                let hold_key = hid_usage_to_layout_key(zmk_studio_api::HidUsage::from(*param1));
                let tap_key = hid_usage_to_layout_key(zmk_studio_api::HidUsage::from(*param2));
            ...
            if *param1 != 0 && *param2 == 0 {
                let p1 = hid_usage_to_layout_key(zmk_studio_api::HidUsage::from(*param1));
